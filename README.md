...
##### 1. Realistic Blur using Depth Map [DONE]
...
##### 5. Blur "rings" (I think it's called onion-ring bokeh?) [DONE]

##### 6. Distorted blur (I think this one's called swirly bokeh?) [DONE]
